    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make(
            ...
            array_merge([
                ...
                'print_length_inches' => 'nullable|numeric|min:0.1|max:50',
        ...
        try {
            ...
            $product = Product::create([
                ...
                'tag_line' => $request->filled('tag_line') ? trim($request->tag_line) : null,
                ...
                'print_length_inches' => $request->filled('print_length_inches') ? (float)$request->print_length_inches : null,
